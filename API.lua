...
local xlp = {
    ...
    ["tween"] = function(time, pos) -- tween to position by (time) + (cframe)
        if game:GetService("Players").LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
            game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(((game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame - pos)).Magnitude / time, Enum.EasingStyle.Linear), {CFrame = pos}):Play(); task.wait(time)
        end
    end,
